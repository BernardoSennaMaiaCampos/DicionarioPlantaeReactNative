...
export default function PlantCreateScreen() {
    ...
    const loadFormData = async () => {
        try {
            setLoadingData(true);
            const [cats, classes, origs] = await Promise.all([
                api.getCategories(),
            ...
            console.error(error);
            Alert.alert('Erro', 'Falha ao carregar dados do formulário.');
        } finally {
    ...
    const handleCreate = async () => {
        ...
        try {
            ...
            console.error(error);
            Alert.alert('Erro', 'Falha ao criar planta.');
        } finally {
            setSubmitting(false);
        }
    };
    ...
    return (
        <SafeAreaView style={styles.container}>
            <ScrollView contentContainerStyle={styles.content}>
                <ThemedText type="title" style={styles.title}>Nova Planta</ThemedText>
